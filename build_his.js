...
const replacements = [
  ['LifeInsurancePage', 'HighInterestSavingsPage'],
  ['Layers, Compass, FileText, Sparkles, Activity, Headset', 'Layers, Compass, FileText, Sparkles, Activity, Headset, Banknote, LineChart, Landmark, Clock, Coins, ShieldCheck, HeartHandshake'],
  ['Compare Health Insurance Plans in Tamil Nadu', 'Compare High Interest Savings Plans in Tamil Nadu'],
  [`Protect Your Family's Health — <span className="text-sky-400">Compare Insurance Plans</span>`, `Grow Your Savings With Confidence — <span className="text-sky-400">Compare High Interest Savings Plans in Tamil Nadu</span>`],
  [`A medical emergency can bring unexpected expenses at any time. SGNL helps you compare health insurance options from participating insurers such as Star Health, Niva Bupa, HDFC ERGO, Care Health, and Manipal Cigna, so you can explore coverage based on your family's healthcare needs and budget.`, `Looking for better ways to grow your savings? SGNL helps you compare savings and deposit options in Tamil Nadu from participating banks and NBFCs, including HDFC Bank, ICICI Bank, State Bank of India, Bajaj Finance, and Axis Bank. Explore options based on your savings goal, preferred tenure, liquidity needs, and eligibility.`],
  ['15+ IRDAI-Approved Insurers', '10+ RBI-Regulated Banks & NBFCs'],
  ['Dedicated Claims & Support Team', 'Dedicated Support Team'],
  ['Why Do You Need Health Insurance?', 'Why Do You Need a High Interest Savings Plan?'],
  ...
  ['Health Insurance Plans We Offer', 'High Interest Savings Plans in Tamil Nadu'],
  [`Whether you're looking to protect yourself, your family, children, or senior citizens, different health insurance options are available based on your healthcare requirements.`, `Explore options based on your savings goal, preferred tenure, liquidity needs, and eligibility.`],
  [`Why Choose <span className="text-sky-500">SGNL</span> for Health Insurance?`, `Why Choose <span className="text-sky-500">SGNL</span> for High Interest Savings?`],
  [`Choosing health insurance can be complicated when every insurer offers different coverage, premiums, waiting periods, and policy conditions. SGNL helps simplify the comparison process.`, `Compare More. Save With Confidence. Stay Supported.`],
  ['Our Trusted Health & General Insurance Partners', 'Our Banking, NBFC & Savings Scheme Partners'],
  [`SGNL works with participating health and general insurers regulated by IRDAI, giving customers access to different health coverage options based on their requirements.`, `SGNL works with participating banks and NBFCs, helping customers explore and compare available savings and deposit options across multiple institutions.`],
  [`What Makes Our Plans <span className="text-sky-400">Worth It?</span>`, `Benefits That Support Your <span className="text-sky-400">Savings Goals</span>`],
  [`Health insurance plans can offer different features designed to make healthcare protection more practical and flexible. Depending on the insurer and policy selected, available benefits may include:`, `Savings and deposit products can offer different interest rates, tenures, and payout options to help you plan your money more effectively:`],
  ['Stay Protected, Stay Prepared', 'Save Smart. Plan With Confidence.'],
...
const whyNeedOld = /const whyNeedInsurance = \[[\\s\\S]*?\];/;
...
content = content.replace(whyNeedOld, whyNeedNew);

const plansOld = /const plansOffered = \[[\\s\\S]*?\];/;
const plansNew = `const plansOffered = [
    {
...
content = content.replace(plansOld, plansNew);
